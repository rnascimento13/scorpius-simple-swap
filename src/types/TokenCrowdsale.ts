...
export interface TokenCrowdsaleInterface extends ethers.utils.Interface {
  functions: {
...
export interface TokenCrowdsale extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenCrowdsaleInterface;
